<?php
 /**
  * Handles all functions regarding the field type image, part of the wordpress media system
  *
  *
...
function showfield($post=null, $element=null){
		...
		//<button onclick=\"tb_show('Test', 'media-upload.php?post_id=98&type=image&wpcf-fields-media-insert=1&TB_iframe=true');return false;\">image upload</button>
